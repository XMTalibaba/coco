...
export const createGoalVisTypeDefinition = (deps: VisTypeVislibDependencies) => ({
  name: 'goal',
  title: i18n.translate('visTypeVislib.goal.goalTitle', { defaultMessage: '目标图' }),
  icon: 'visGoal',
  description: i18n.translate('visTypeVislib.goal.goalDescription', {
    defaultMessage: '目标图指示与最终目标的接近程度.',
  }),
    ...
    schemas: new Schemas([
      {
        ...
        name: 'metric',
        title: i18n.translate('visTypeVislib.goal.metricTitle', { defaultMessage: '指标' }),
        min: 1,
        aggFilter: [
          '!std_dev',
          '!geo_centroid',
