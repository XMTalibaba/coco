...
export const ManagerMsl = compose(
  withReduxProvider,
  withGlobalBreadcrumb([{ text: '' }, { text: 'virus' }, { text: 'virusfound' }]),
    ...
    return (
                  ...
                  <EuiFlexItem grow={false}>
                    <EuiPanel paddingSize="m" >
                      <div>
                        ...
                        <EuiFormRow label="Name" helpText="mysql-monitor">
      ...
      >
        <EuiSelect
          ...
          onChange={() => {}}
          options={[
            { value: 'option_one', text: 'MySql' },
            { value: 'option_two', text: 'oracle' },
         
          ]}
        />
      </EuiFormRow>
      <EuiFormRow label="JDBCURL" helpText="jdbc:mysql://127.0.0.1:3306/test?useUnicode=true&characterEncoding=utf8&serverTimezone=UTC">
                          <EuiFieldText name="first" />
                        </EuiFormRow>
                        <EuiFormRow label="JDBC Name" helpText="I am some friendly help text.">
                          <EuiFieldText name="first" />
                        </EuiFormRow>
                        <EuiFormRow label="JDBC password" helpText="I am some friendly help text.">
                        <EuiFieldPassword
      ...
      />
                        ...
                        <EuiFormRow label="export" helpText="mysg-dblog-%[+YYYYMMdd}">
                          <EuiFieldText name="first" />
                        </EuiFormRow>
      </EuiForm>
      </EuiFlexItem>
                ...
                Database: MSQL
                  ...
                  <div className='hang'>
                  force-rdns: 'mysql://127.0.0.1:3306/test?useUnicode=true&characterEncoding=utf8&serverTimezone=UTC'
                  </div>
                  <div className='hang'>
                  Output: mysg-dblog-%
                  </div>
                <div className='hang'>
                llow_override_date: true
                  </div>
                  <div className='hang'>
                  bind_address:0.0.0.8
                  </div>
                  <div className='hang'>
                  xpand_struetured_data: false
                  </div>
                  <div className='hang'>
                  xpand_struetured_data: false
                  </div>
                  ...
                  <div className='hang'>
                  number_worker_threnda: 4
                  </div>
                  <div className='hang'>
                  override.source: empty
                  </div>
                  <div className='hang'>
                  port: 1519
                  </div>
                  <div className='hang'>
                  cybuffer-size: 262144
                  </div>
                  <div className='hang'>
                store_full_message: true
                  ...
                  <div className='right'>
                  <div className='hang' style={{color:"green"}}>
                  running
                  </div>
                  <div className='hang' >
                  count：39812391
              ...
              Name：mysg-dblog
                ...
                store_full_message: true
                  ...
                  <div className='right'>
                  <div className='hang' style={{color:"red"}}>
                  running
                  </div>
                  <div className='hang' >
                  count：0
