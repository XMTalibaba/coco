      ...
      <EuiPageContent>
          ...
          <EuiCallOut
            ...
            title={
              <FormattedMessage
                ...
                defaultMessage="无索引模式匹配 ID {indexPatternId}"
          ...
          <EuiCallOut
            ...
            title={
              <FormattedMessage
                ...
                defaultMessage="无法执行搜索"
              />
            }
          >
            <FormattedMessage
              id="discover.doc.somethingWentWrongDescription"
              defaultMessage="{indexName} 缺失。"
        ...
        {reqState === ElasticRequestState.Loading && (
          <EuiCallOut data-test-subj={`doc-msg-loading`}>
            ...
            <FormattedMessage id="discover.doc.loadingDescription" defaultMessage="等待..." />
          </EuiCallOut>
        )}
