  ...
  constructor(props) {
    ...
    this.columns = [
      ...
      },
      {
        ...
        render: (value, item) => {
          return (
            <EuiToolTip position="top" content={`显示${value}内容`}>
              <EuiLink
                onClick={async event => {
  ...
  renderInfo(id, level, file, path, groups) {
    return (
      ...
      <EuiFlexItem key="rule_ids" grow={1}>
        ...
        <span>
          <EuiToolTip position="top" content={`按规则ID过滤: ${id}`}>
            <EuiLink
        ...
        <EuiFlexItem key="level" grow={1}>
          ...
          <span>
            <EuiToolTip position="top" content={`按等级过滤: ${level}`}>
              <EuiLink
        ...
        <EuiFlexItem key="file" grow={1}>
          <b style={{ paddingBottom: 6 }}>文件</b>
          <span>
            <EuiToolTip position="top" content={`按文件过滤: ${file}`}>
              <EuiLink
        ...
        <EuiFlexItem key="path" grow={1}>
          <b style={{ paddingBottom: 6 }}>路径</b>
          <span>
            <EuiToolTip position="top" content={`按路径过滤: ${path}`}>
              <EuiLink
      ...
      const values = compliance[key].map((element, index) => {
        return (
          <span key={index}>
            ...
            >
              <EuiToolTip position="top" content="按合规性过滤">
                <span>{element}</span>
              </EuiToolTip>
            </EuiLink>
              ...
              <EuiFlexItem>
                <EuiTitle>
                  <span style={{ fontSize: '22px' }}>
                    <EuiToolTip position="right" content="返回规则">
                      <EuiButtonIcon
                        aria-label="Back"
                        color="primary"
                        iconSize="l"
