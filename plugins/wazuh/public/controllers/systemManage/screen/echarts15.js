...
export class Echarts15 extends Component {
  constructor(props) {
    super(props);
    this.myCharts1 = null;
    this.myCharts2 = null;
  ...
  buildChart() {
    ...
    let timer1 = setInterval(() => {
      let chartDom = document.getElementById('echartsBox15_1');
      if (chartDom) {
        clearInterval(timer1);
        if (!this.myCharts1) this.myCharts1 = echarts.init(document.getElementById('echartsBox15_1'));
        this.myCharts1.setOption(option1);
        if (!this.myCharts2) this.myCharts2 = echarts.init(document.getElementById('echartsBox15_2'));
        this.myCharts2.setOption(option2);
        if (!this.myCharts3) this.myCharts3 = echarts.init(document.getElementById('echartsBox15_3'));
    ...
    return (
      <div style={{ display: 'flex', height: '100%', justifyContent: 'space-around' }}>
        <div style={{ position: 'relative', width: '30%' }}>
          ...
          <div style={{ width: '100%', height: 'calc(100% - 40px)' }} id="echartsBox15_1" />
          <div className="echarts10Cicle" />
        </div>
        <div style={{ position: 'relative', width: '30%' }}>
        <div className="echarts10Title">硬盘占用率</div>
          <div style={{ width: '100%', height: 'calc(100% - 40px)' }} id="echartsBox15_2" />
          <div className="echarts10Cicle" />
        </div>
        <div style={{ position: 'relative', width: '30%' }}>
        <div className="echarts10Title">内存占用率</div>
          <div style={{ width: '100%', height: 'calc(100% - 40px)' }} id="echartsBox15_3" />
          <div className="echarts10Cicle" />
        </div>
      </div>
    )
