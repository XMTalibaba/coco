    ...
    interval && interval.scaled ? (
      <strong data-test-subj="currentlyScaledText" className="eui-displayBlock">
        <FormattedMessage
          ...
          defaultMessage="当前缩放至 {bucketDescription}"
