...
function DefaultEditorAggAdd({
  ...
  const groupNameLabel =
    groupName === AggGroupNames.Buckets
      ? i18n.translate('visDefaultEditor.aggAdd.bucketLabel', { defaultMessage: '存储桶' })
      : i18n.translate('visDefaultEditor.aggAdd.metricLabel', { defaultMessage: '指标' });
          ...
          <EuiPopoverTitle>
            {(groupName !== AggGroupNames.Buckets || !stats.count) && (
              <FormattedMessage
                ...
                defaultMessage="添加 {groupNameLabel}"
            ...
            {groupName === AggGroupNames.Buckets && stats.count > 0 && (
              <FormattedMessage
                ...
                defaultMessage="添加子-{groupNameLabel}"
                values={{ groupNameLabel }}
              />
            )}
          </EuiPopoverTitle>
