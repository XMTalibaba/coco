...
class WzEditConfiguration extends Component {
      ...
      this.addToast({
        title: (
          <Fragment>
            ...
            &nbsp;
            <span>
              <b>{this.props.clusterNodeSelected || 'Manager'}</b>
              配置已经更新
            </span>
          </Fragment>
        ),
        ...
        this.addToast({
          title: (
            <Fragment>
              ...
              &nbsp;
              <span>
                节点可能需要一些时间重新启动，可能需要执行刷新以查看所有节点。
              </span>
            </Fragment>
          ),
          color: 'success'
  ...
  render() {
    ...
    return (
      <Fragment>
        <WzConfigurationPath
          title={`${clusterNodeSelected ? '集群' : '管理器'} 配置`}
        ...
        >
          ...
          <EuiFlexItem grow={false}>
            ...
            >
              {restarting ? '重启中' : '重启' } {clusterNodeSelected || '管理器'}
            </WzButtonPermissions>
          </EuiFlexItem>
        </WzConfigurationPath>
