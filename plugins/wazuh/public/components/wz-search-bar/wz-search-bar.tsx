...
[suggestItem[], SuggestHandler | undefined, string, boolean] {
  ...
  useEffect(() => {
    setHandler(new SuggestHandler({...props, status, setStatus, setInvalid, setIsOpen, keyName: props.keyName ? props.keyName : '' }, setInputValue))
  ...
  useEffect(() => {
    handler && handler.buildSuggestItems(inputValue)
      ...
      .catch((e)=>{e !== '正在进行新请求' && console.log(e)});
  }, [inputValue, handler]);
