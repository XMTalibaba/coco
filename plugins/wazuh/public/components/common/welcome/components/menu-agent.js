...
class WzMenuAgent extends Component {
  constructor(props) {
    ...
    this.agentSections = {
      ...
      general: { id: WAZUH_MODULES_ID.SECURITY_EVENTS, text: '安全事件', isPin: this.menuAgent.general ? this.menuAgent.general : false },
      fim: { id: WAZUH_MODULES_ID.INTEGRITY_MONITORING, text: '完整性监控', isPin: this.menuAgent.fim ? this.menuAgent.fim : false },
      aws: { id: WAZUH_MODULES_ID.AMAZON_WEB_SERVICES, text: 'Amazon AWS', isPin: this.menuAgent.aws ? this.menuAgent.aws : false },
      gcp: { id: WAZUH_MODULES_ID.GOOGLE_CLOUD_PLATFORM, text: '谷歌云平台', isPin: this.menuAgent.gcp ? this.menuAgent.gcp : false },
      pm: { id: WAZUH_MODULES_ID.POLICY_MONITORING, text: '策略监控', isPin: this.menuAgent.pm ? this.menuAgent.pm : false },
      sca: { id: WAZUH_MODULES_ID.SECURITY_CONFIGURATION_ASSESSMENT, text: '安全配置评估', isPin: this.menuAgent.sca ? this.menuAgent.sca : false },
      audit: { id: WAZUH_MODULES_ID.AUDITING, text: '系统审计', isPin: this.menuAgent.audit ? this.menuAgent.audit : false },
      ...
      vuls: { id: WAZUH_MODULES_ID.VULNERABILITIES, text: '漏洞', isPin: this.menuAgent.vuls ? this.menuAgent.vuls : false },
      ...
      docker: { id: WAZUH_MODULES_ID.DOCKER, text: 'Docker监听器', isPin: this.menuAgent.docker ? this.menuAgent.docker : false },
