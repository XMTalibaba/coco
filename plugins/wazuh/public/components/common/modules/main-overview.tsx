...
export const MainModuleOverview = compose(
    ...
    setGlobalBreadcrumb() {
      ...
      if (WAZUH_MODULES[this.props.currentTab]) {
        let breadcrumb = [
          ...
          {
            text: currentAgent.id ? (<span>安全管理
              <EuiBadge
            ...
            <EuiFlexGroup justifyContent={'spaceBetween'}>
              <EuiFlexItem grow={false}>
                <span style={{ display: 'inline-flex' }}>
                  <EuiTitle size="s">
                    <h1>
                      {(this.props.modulesTab !== 'none') &&
                        <span>&nbsp;{WAZUH_MODULES[this.props.modulesTab].title}&nbsp;&nbsp;</span>
                      }
                      {(this.props.logModules !== 'none' && this.props.logModules !== 'securityLog') &&
                        <span>&nbsp;{WAZUH_MODULES[this.props.logModules].title}&nbsp;&nbsp;</span>
                      }
                      {(this.props.modulesTab === 'none' && this.props.logModules === 'none' || this.props.logModules === 'securityLog') &&
                  ...
                  <EuiPopover
                    ...
                    <div style={{ width: '400px' }}>
                      {(this.props.modulesTab !== 'none') &&
                        <span>&nbsp;{WAZUH_MODULES[this.props.modulesTab].description}&nbsp;&nbsp;</span>
                      }
                      {(this.props.logModules !== 'none' && this.props.logModules !== 'securityLog') &&
                        <span>&nbsp;{WAZUH_MODULES[this.props.logModules].description}&nbsp;&nbsp;</span>
                      }
                      {(this.props.modulesTab === 'none' && this.props.logModules === 'none' || this.props.logModules === 'securityLog') &&
                        <span>&nbsp;{WAZUH_MODULES[this.props.section].description}&nbsp;&nbsp;</span>
                      }
                    </div>
                  </EuiPopover>
                </span>
              ...
              { !this.props.renderTabs() && (
                <EuiFlexGroup>
                  ...
                  {(this.props.selectView === 'dashboard') &&
