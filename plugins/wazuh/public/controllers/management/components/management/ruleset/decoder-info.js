    ...
    return (
      <EuiFlexGrid columns={4}>
        <EuiFlexItem key="position">
          <b style={{ paddingBottom: 6 }}>位置</b>{position}
        </EuiFlexItem>
        <EuiFlexItem key="file">
          <b style={{ paddingBottom: 6 }}>文件</b>
          <span>
            <EuiToolTip position="top" content={`根据文件筛选: ${file}`}>
        ...
        <EuiFlexItem key="path">
          ...
          <span>
            <EuiToolTip position="top" content={`根据路径筛选: ${path}`}>
              ...
              <EuiFlexItem grow={false}>
                <EuiTitle>
                  <span style={{ fontSize: '22px' }}>
                    <EuiToolTip position="right" content="返回解码器">
                      <EuiButtonIcon
                        aria-label="返回"
                        color="primary"
                        iconSize="l"
