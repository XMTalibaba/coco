...
export const RunningRecord = compose(
  withReduxProvider
)(class RunningRecord extends Component {
  _isMount = false;
  constructor(props) {
    super(props);
  ...
  buildFilter() {
    ...
    let formattedFilter = buildPhrasesFilter({ name: 'rule.id', type: "string" }, ['100034', '100035', '502'], this.indexPattern);
