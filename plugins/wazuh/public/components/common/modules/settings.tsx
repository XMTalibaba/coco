        ...
        <EuiPage>
          <EuiPanel>
            ...
            {(section === 'pm' || section === 'sca' || section === 'audit') &&
              <WzConfigurationPolicyMonitoring {...this.props} updateBadge={(e) => this.updateBadge(e)} onlyShowTab={section === 'pm' ? '策略监控' : section === 'audit' ? '系统审计' : section === 'sca' ? '安全配置评估': undefined}/>}
