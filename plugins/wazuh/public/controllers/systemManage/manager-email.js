...
import { Echarts20 } from './screen/echarts20' // 时间同步告警趋势图-折线图
import { Echarts21 } from './screen/echarts21' // 时间同步告警趋势图-折线图
import { Echarts22 } from './screen/echarts22' // 时间同步告警趋势图-折线图
import { Echarts23 } from './screen/echarts23' // 时间同步告警趋势图-折线图
import { Echarts24 } from './screen/echarts24' // 时间同步告警趋势图-折线图
export const ManagerEmail = compose(
	withReduxProvider,
	withGlobalBreadcrumb([{ text: '' }, { text: '首页' }, { text: '安全驾驶仓' }]),
	withUserAuthorizationPrompt(null, AppState.getPagePermission)
)(class ManagerEmail extends Component {
  constructor(props) {
    super(props);
    this.offset = 120;
    this.state = {
  ...
  updateHeight = () => {
    ...
    const designDraftHeight = 1000; //设计稿的高度
    ...
    return (
      <EuiFlexGroup direction="column">
				<EuiFlexItem grow={false}>
						...
						<div className='wz-module-body-notab' style={{padding:'0'}}>
							<EuiPage>
                    ...
                    <div className="echartsWarp">
                      <div style={{ width: '30%', height: '100%' }}>
                        <div className="echartsItem">
                          <div className="echartsTitle">日志数据统计</div>
                          <div className="echartsContent">
                            <Echarts20 isChangeSize={isChangeSize} />
                            </div>
                        </div>
                        <div className="echartsItem">
                          <div className="echartsTitle">日志趋势</div>
                          <div className="echartsContent">
                            {/* <Echarts5 isChangeSize={isChangeSize} /> */}
                            <Echarts21 isChangeSize={isChangeSize} />
                          </div>
                        </div>
                        <div className="echartsItem">
                          <div className="echartsTitle">账号登录轮播</div>
                          <div className="echartsContent"><Echarts22 isChangeSize={isChangeSize} /></div>
                        </div>
                      </div>
                      <div style={{ width: '40%', margin: '0 10px', height: '100%' }}>
                        ...
                        <div className="echartsItem">
                          <div className="echartsTitle">最新告警</div>
                          <div className="echartsContent"><Echarts23 isChangeSize={isChangeSize} /></div>
                        </div>
                      </div>
                      <div style={{ width: '30%', height: '100%' }}>
                        <div className="echartsItem">
                          <div className="echartsTitle"> 输入源接收top5</div>
                          <div className="echartsContent"><Echarts24 isChangeSize={isChangeSize} /></div>
                        </div>
                        <div className="echartsItem">
                          <div className="echartsTitle">告警分布趋势</div>
                          <div className="echartsContent">
                            {/* <Echarts7 isChangeSize={isChangeSize} /> */}
                            <Echarts1 isChangeSize={isChangeSize} />
                          </div>
                        </div>
                        <div className="echartsItem">
                          ...
                          <div className="echartsContent">
                            ...
                            <Echarts10 isChangeSize={isChangeSize} />
                          </div>
                        </div>
                      </div>
                    </div>
