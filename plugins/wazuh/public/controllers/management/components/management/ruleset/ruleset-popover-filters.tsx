...
class WzPopoverFilters extends Component {
  ...
  constructor(props) {
    ...
    this.filters = {
      rules: [
        { label: '文件', value: 'file' }, { label: '路径', value: 'path' }, { label: '等级', value: 'level' },
        { label: '组', value: 'group' }, { label: 'PCI控制', value: 'pci' }, { label: 'GDPR', value: 'gdpr' }, { label: 'HIPAA', value: 'hipaa' }, { label: 'NIST-800-53', value: 'nist-800-53' }, { label: 'TSC', value: 'tsc' }
      ],
      decoders: [
        { label: '文件', value: 'file' }, { label: '路径', value: 'path' }
      ]
    };
  }
