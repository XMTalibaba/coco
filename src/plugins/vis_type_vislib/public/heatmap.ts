...
export const createHeatmapVisTypeDefinition = (deps: VisTypeVislibDependencies) => ({
  name: 'heatmap',
  title: i18n.translate('visTypeVislib.heatmap.heatmapTitle', { defaultMessage: '热力图' }),
  icon: 'heatmap',
  description: i18n.translate('visTypeVislib.heatmap.heatmapDescription', {
    defaultMessage: '为矩阵中的单元格添加阴影',
  }),
  ...
  editorConfig: {
    ...
    schemas: new Schemas([
      ...
      },
      {
        group: AggGroupNames.Buckets,
        name: 'group',
        title: i18n.translate('visTypeVislib.heatmap.groupTitle', { defaultMessage: 'Y轴' }),
        min: 0,
        max: 1,
        aggFilter: ['!geohash_grid', '!geotile_grid', '!filter'],
      },
