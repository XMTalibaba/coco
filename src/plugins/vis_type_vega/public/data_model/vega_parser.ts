      ...
      if (!spec.$schema) {
        throw new Error(
          i18n.translate('visTypeVega.vegaParser.inputSpecDoesNotSpecifySchemaErrorMessage', {
            defaultMessage: `您的规范要求 {schemaParam} 字段包含\nVega（请参见 {vegaSchemaUrl}）或\nVega-Lite（请参见 {vegaLiteSchemaUrl}）的有效 URL。\n该 URL 仅限标识符。您的浏览器将不访问此 URL.`,
            values: {
              schemaParam: '"$schema"',
    ...
    if (!autosize && typeof autosize !== 'undefined') {
      this._onWarning(
        i18n.translate('visTypeVega.vegaParser.autoSizeDoesNotAllowFalse', {
          defaultMessage:
            '{autoSizeParam} 已启用，只能通过将 {autoSizeParam} 设置为 {noneParam} 来禁用',
          values: {
    ...
    if (
      ...
      this._onWarning(
        i18n.translate('visTypeVega.vegaParser.widthAndHeightParamsAreIgnored', {
          defaultMessage:
            '{widthParam} 和 {heightParam} 参数已忽略，因为 {autoSizeParam} 已启用。将 {autoSizeParam} 设置为 {noneParam} 可禁用',
          values: {
            widthParam: '"width"',
            heightParam: '"height"',
            autoSizeParam: '"autosize"',
      ...
      if (this._config && this._config.controlsLocation === undefined) {
        ...
        throw new Error(
          i18n.translate('visTypeVega.vegaParser.unrecognizedControlsLocationValueErrorMessage', {
            defaultMessage:
              '无法识别的 {controlsLocationParam} 值。应为 [{locToDirMap}] 之一',
            values: {
    ...
    if (dir !== undefined && dir !== 'horizontal' && dir !== 'vertical') {
      throw new Error(
        i18n.translate('visTypeVega.vegaParser.unrecognizedDirValueErrorMessage', {
          defaultMessage: '{dirParam} 值无法识别。应为 [{expectedValues}] 之一',
      ...
      if (this.spec._hostConfig !== undefined) {
        ...
        if (!_.isPlainObject(result)) {
          throw new Error(
            i18n.translate('visTypeVega.vegaParser.hostConfigValueTypeErrorMessage', {
              defaultMessage: '如果存在，{configName} 必须为对象',
        ...
        this._onWarning(
          i18n.translate('visTypeVega.vegaParser.hostConfigIsDeprecatedWarningMessage', {
            defaultMessage:
              '{deprecatedConfigName} 已弃用。请改用 {newConfigName}.',
            values: {
    ...
    if (result.position === undefined) {
      ...
      throw new Error(
        i18n.translate(
          ...
          {
            defaultMessage: '意外的 {configurationName} 配置值',
    ...
    if (result.padding === undefined) {
      ...
      throw new Error(
        i18n.translate('visTypeVega.vegaParser.paddingConfigValueTypeErrorMessage', {
          defaultMessage: '{configName} 应为数字',
    ...
    if (res.mapStyle !== `default` && res.mapStyle !== false) {
      this._onWarning(
        i18n.translate('visTypeVega.vegaParser.mapStyleValueTypeWarningMessage', {
          defaultMessage:
            '{mapStyleConfigName} 可能为 {mapStyleConfigFirstAllowedValue} 或 {mapStyleConfigSecondAllowedValue}',
          values: {
      ...
      if (
        ...
        this._onWarning(
          i18n.translate('visTypeVega.vegaParser.maxBoundsValueTypeWarningMessage', {
            defaultMessage: '{maxBoundsConfigName} 必须为具有四个数字的数组',
            values: {
    ...
    if (val === undefined) {
      ...
      this._onWarning(
        i18n.translate('visTypeVega.vegaParser.someKibanaParamValueTypeWarningMessage', {
          defaultMessage: '{configName} 必须为布尔值',
          values: {
    ...
    if (versionCompare(schema.version, libVersion) > 0) {
      this._onWarning(
        i18n.translate('visTypeVega.vegaParser.notValidLibraryVersionForInputSpecWarningMessage', {
          defaultMessage:
            '输入规范使用 {schemaLibrary} {schemaVersion}，但 {schemaLibrary} 的当前版本为 {libraryVersion}.',
          values: {
        ...
        if (obj.values !== undefined || obj.source !== undefined) {
          throw new Error(
            i18n.translate(
              ...
              {
                defaultMessage:
                  '数据不得包含 {urlParam}、{valuesParam} 和 {sourceParam} 中的多个值',
                values: {
                  urlParam: '"url"',
                  valuesParam: '"values"',
                  sourceParam: '"source"',
