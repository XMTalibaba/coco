      ...
      this.props.toastNotifications.addDanger({
        title: toMountPoint(
          <FormattedMessage
            ...
            defaultMessage="无法删除{entityName}"
        ...
        <EuiConfirmModal
          title={
            <FormattedMessage
              ...
              defaultMessage="删除 {itemCount} 个 {entityName}？"
              values={{
        ...
        >
          <p>
            <FormattedMessage
              ...
              defaultMessage="无法恢复删除的 {entityNamePlural}."
          ...
          >
            <p>
              <FormattedMessage
                ...
                defaultMessage="您有 {totalItems} 个{entityNamePlural}，但您的“{listingLimitText}”设置阻止下表显示 {listingLimitValue} 个以上."
                values={{
          ...
          >
            <p>
              <FormattedMessage
                ...
                defaultMessage="无法提取 {entityName} 列表：{message}."
                values={{
    ...
    if (this.props.noItemsFragment) {
      ...
      return (
        <FormattedMessage
          ...
          defaultMessage="没有可用的{entityNamePlural}."
          values={{ entityNamePlural: this.props.entityNamePlural }}
        />
      );
    }
  ...
  renderTable() {
    ...
    const noItemsMessage = (
      <FormattedMessage
        ...
        defaultMessage="没有任何{entityNamePlural}匹配您的搜索."
        values={{ entityNamePlural: this.props.entityNamePlural }}
      />
    );
    return (
