...
export const createLineVisTypeDefinition = (deps: VisTypeVislibDependencies) => ({
  name: 'line',
  title: i18n.translate('visTypeVislib.line.lineTitle', { defaultMessage: '折线图' }),
  icon: 'visLine',
    ...
    schemas: new Schemas([
      {
        ...
        name: 'metric',
        title: i18n.translate('visTypeVislib.line.metricTitle', { defaultMessage: 'Y轴' }),
        min: 1,
      ...
      },
      {
        group: AggGroupNames.Metrics,
        name: 'radius',
        title: i18n.translate('visTypeVislib.line.radiusTitle', { defaultMessage: '点大小' }),
        min: 0,
        max: 1,
      ...
      },
      {
        ...
        name: 'segment',
        title: i18n.translate('visTypeVislib.line.segmentTitle', { defaultMessage: 'X轴' }),
        min: 0,
        max: 1,
