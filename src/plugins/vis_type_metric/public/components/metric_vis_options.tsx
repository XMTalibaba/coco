  ...
  return (
    <>
      <EuiPanel paddingSize="s">
        <EuiTitle size="xs">
          <h3>
            <FormattedMessage id="visTypeMetric.params.settingsTitle" defaultMessage="设置" />
          </h3>
        </EuiTitle>
        <EuiSpacer size="s" />
      ...
      <EuiPanel paddingSize="s">
        <EuiTitle size="xs">
          <h3>
            <FormattedMessage id="visTypeMetric.params.rangesTitle" defaultMessage="范围" />
          </h3>
        </EuiTitle>
        <EuiSpacer size="s" />
      ...
      <EuiPanel paddingSize="s">
        <EuiTitle size="xs">
          <h3>
            <FormattedMessage id="visTypeMetric.params.style.styleTitle" defaultMessage="样式" />
          </h3>
        </EuiTitle>
        <EuiSpacer size="s" />
