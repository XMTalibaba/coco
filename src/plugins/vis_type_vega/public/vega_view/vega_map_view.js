      ...
      if (!baseMapOpts) {
        this.onWarn(
          i18n.translate('visTypeVega.mapView.mapStyleNotFoundWarningMessage', {
            defaultMessage: '找不到 {mapStyleParam}',
    ...
    if (minZoom > maxZoom) {
      this.onWarn(
        i18n.translate('visTypeVega.mapView.minZoomAndMaxZoomHaveBeenSwappedWarningMessage', {
          defaultMessage: '已交换 {minZoomPropertyName} 和 {maxZoomPropertyName}',
          values: {
