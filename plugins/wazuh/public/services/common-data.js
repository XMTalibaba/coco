...
//    this.globalState = globalState;
  ...
  checkTabLocation() {
    if (this.$location.search().tab) {
      ...
      // return 'welcome';
      this.$location.search('tab', 'general');
      return 'general';
    }
  }

  /**
   * Check the modulesTab location
   */
   checkModulesTabLocation() {
    if (this.$location.search().modulesTab) {
      return this.$location.search().modulesTab;
    } else {
      return 'none';
    }
  }
  ...
  /**
   * Check the logModules location
   */
   checkLogModulesLocation() {
    if (this.$location.search().logModules) {
      return this.$location.search().logModules;
    } else {
      return 'none';
    }
  }
